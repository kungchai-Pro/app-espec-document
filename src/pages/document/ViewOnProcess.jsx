...
import { columns } from './component/viewflowprocess/columnOnprocess';
...
function ViewOnProcess() {
    ...
    async function jouranlall() {
        ...
        await FetchApis.FethcGet(`/document/JournalNotSuccessfullylist`).then(res => {
                ...
                <div>
                    <div>
                        <div style={{ backgroundColor: '#ececec' }}>
                            ...
                            <p className="text-gray-600 mt-2">Manage document On Process</p>
