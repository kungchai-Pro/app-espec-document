...
import PopUpcuEditSlot from '../newDocument/popupcomponent/popUpcuEditSlot';
  ...
  function Retureimag({ idjornal, dataDetial }) {
    ...
    return (<div style={{ width: '100%' }}>
      ...
      {result.map((val, index) =>
        <div>
          <Box sx={{ height: 'auto', marginTop: '1', width: '100%', display: 'flex' }}>
      ...
      <div style={{ marginTop: 5, marginRight: 30, flexDirection: 'row', alignItems: 'center', justifyContent: 'flex-end', display: 'flex' }}>
        <div style={{ marginRight: 10 }}>
          <Button variant="outlined" color='warning'
            size="small"
            startIcon={<AddBoxIcon />} onClick={() => isAddDetailList(true)}>
            Add Detail
          </Button>
        </div>
        <div>
                ...
                <div style={{ padding: 10, backgroundColor: '#EDF5F3' }}>
                  ...
                  <div>
                    <div style={{ flexDirection: 'row', display: 'flex' }}>
                      ...
                      <PopUpbatchversion getBatchproduct={getBatchproduct} valDateail={dataDetial}
                        index={index} JournalCode={item.JournalCode} />
                      <div style={{
...
export default DraftAddDetaildocument