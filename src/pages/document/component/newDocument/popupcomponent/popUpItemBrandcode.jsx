...
function PopUpItemBrandcode(props) {
  ...
  const onclickCustomerDetail = (BRANDCODE) => {
    props.inDataCustomerBrancode(BRANDCODE);
    setOpen(false);
  }
  ...
  const columns = [
...

    {
      ...
      selector: row =>
        <div>
          <button onClick={() => onclickCustomerDetail(row.BRANDCODE)}>เลือก</button>
        </div>,
      sortable: true,
      grow: 1,
    },
    ...
    <div>
      <React.Fragment>
        ...
        >
          ...
          <div style={{ flexDirection: 'row', justifyContent: 'flex-end', backgroundColor: 'red', alignContent: 'end', display: 'flex' }}>
...
export default PopUpItemBrandcode