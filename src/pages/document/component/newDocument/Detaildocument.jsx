...
import PopUpbatchversion from './Editcomponent/popUpbatchversion';
...
const Detaildocument = (props) => {
          ...
          <div className='row-pace-w100-line'
            ...
            <div style={{ width: '65%', padding: 10 }} className='row-pace-w100-line'>
              <div style={{
                ...
                <img src={host + `/file/images/files/${val.LocationPic}`} alt="My local" width={'100%'} />
                {/* <ImageZoom
              ...
              <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'space-between', height: '100%' }}>
                ...
                <div>
                  ...
                  <center>
                    ...
                    <div>
                      <label style={{ fontSize: 12 }}>{moment(val.ConfirmDateTime).format('DD/MM/yyy hh:mm:ss')}</label>
                    </div>
                  </center>
                </div>
  ...
  // ทำการ popUp แล้ว create data document detail เลยทันที --->
  ...
  const inDetailItemId = (Itemid, ItemName, SpecID, GrossWidth, Grossdepth, Grossheight, Netweight, Taraweight, GrossWeight, index) => {
  ...
  return (<React.Fragment>
    ...
    <Container>
      <div style={{ marginTop: 5, marginRight: 30, flexDirection: 'row', justifyContent: 'flex-end', display: 'flex' }}>
        <Button variant="outlined" color='warning' startIcon={<AddBoxIcon />} onClick={() => isAddDetailList(true)}>
          Add Detail
        </Button>
      </div>
