...
import PopUpEditjournalitem from './popUpEditjournalitem';
import PopUpEditjournalbatch from './popUpEditjournalbatch';
import PopUpHitoryNote from './popUpHitoryNote';


const Editjournalgroup = () => {
    ...
    const [noteallist, setNotallist] = useState([]);
        ...
        <div>
            ...
            <Container >
                ...
                {datajournal.length > 0 && <div className='row-pace-w100-line' style={{ fontSize: 14 }}>
                    <div style={{ backgroundColor: '#f9d4ae', padding: 10, fontWeight: '900' }}>
                        <label>แก้ไขข้อมูลแบบ กลุ่ม เอกสาร {datajournal[0].journalGroupID} </label>
                    </div>
                ...
                <div style={{ margin: 3, padding: 5, backgroundColor: '#F9FAFB' }}>
                    <div style={{ flexDirection: 'row', justifyContent: 'space-between', display: 'flex' }}>
                        ...
                        <div>
                            {datajournal.length > 0 && datajournal[0].editType == '1' ? <PopUpEditjournalitem noteallist={noteallist} datajournal={datajournal}/> : <PopUpEditjournalbatch noetelistbatch={noetelistbatch} datajournal={datajournal}/>}
                        </div>
                    </div>
                    {noetelistitem.length != 0 &&
                        <div style={{ width: '100%', backgroundColor: '#ffff', fontSize: 12 }}>
...
export default Editjournalgroup